...
namespace functions4
{
    class Program
    {
        static void TenNumbers()
        {
            ...
            Console.WriteLine("Suurin syötetty luku on {0} joka oli {1}.luku", max, maxIndex);
        }

        static void Main()
        {
            Console.WriteLine("Syötä kymmenen lukua, ohjelma tulostaa luvut sekä ilmoittaa suurimman.");
            TenNumbers();
            Console.ReadKey();
        }
    }
